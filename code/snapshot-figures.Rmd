---
title: "A Snapshot of Montana's Early Childhood Workforce figures"
...
snapshotOrg <- read_csv("data/snapshot.csv")
...
fgCareerLevel <- focusGroup[c(1, 3, 4)]
...
```{r, echo = FALSE, warning = FALSE, message = FALSE, fig.width = 4.5}
# fig 4
# role type by age 
# bar graph
...
fig5 <- ggplot(yearsFieldDF, aes(x = "", y = yearsFieldCount, fill = yearsInField)) + 
...
yearsJobDF$yearsInJob <- factor(yearsJobDF$yearsInJob, levels = c("5 years or less", "6 - 10 years", 
...
```{r eval = FALSE, include = FALSE}
# not using
# wage increase by likelihood current position
# bar graph
...
```{r, echo = FALSE, warning = FALSE, message = FALSE,fig.width=5.5, fig.height=5}
# fig 15
# education by role
# bar graph
